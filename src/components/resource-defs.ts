...
export const resourceDefs: Record<string, CrudConfig> = {
  patients: {
    ...
    fields: [
      ...
      { name: "neededHoursPerWeek", label: "Care hours needed / week", type: "number", required: true },
      { name: "availableDays", label: "Days available (e.g. MO,WE,FR)", type: "text", required: true },
  ...
  caregivers: {
    ...
    fields: [
      ...
      { name: "skillSet", label: "Skills (comma-sep)", type: "text", full: true, required: true },
      { name: "maxHoursPerWeek", label: "Hours available / week", type: "number", required: true },
      { name: "availableDays", label: "Days available (e.g. MO,WE,FR)", type: "text", required: true },
